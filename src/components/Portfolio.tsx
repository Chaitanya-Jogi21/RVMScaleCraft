...
const projects: Project[] = [
  ...
  {
    id: 8,
    title: 'Dr. Deshmukh Homeopathic',
    category: 'Performance Marketing',
    stats: 'Genuine Patient Leads',
    isLogoCard: true,
    logo: '/dr-deshmukh-logo.png',
    caseStudy: {
      client: 'Dr. Deshmukh Homeopathic',
      industry: 'Healthcare / Homeopathy',
      location: 'Nagpur, Maharashtra',
      overview: 'Dr. Anurag Deshmukh is a homeopathy specialist from Nagpur with over 14 years of experience in providing effective treatment and patient care.',
      challenge: 'The clinic wanted to test our lead generation capabilities through a short trial period and required genuine, profitable patient leads through digital advertising.',
      solution: [
        'Meta Ads campaigns',
        'Lead generation campaigns',
      ...
      goal: 'Generate genuine patient inquiries and profitable leads through well-structured advertising campaigns. Successful results would lead to a long-term partnership including social media management.',
      results: [
        'Improved online visibility',
        'Increased patient inquiries',
        'Strong lead generation foundation',
        'Successful campaign testing',
      ],
    },
  },
  {
    id: 9,
    title: 'KK Dental Clinic',
    category: 'Performance Marketing',
    stats: 'High-Quality Inquiries',
    isLogoCard: true,
    logo: '/kk-dental-logo.png',
    caseStudy: {
      client: 'KK Dental Clinic',
      industry: 'Dental Healthcare',
      location: 'Nagpur, Maharashtra',
      overview: 'KK Dental Clinic is a dental practice in Nagpur known for quality treatment, patient care, and professional dental services.',
      challenge: 'The dental industry has strong competition in their local market. The objective was to generate genuine and profitable patient leads through Meta Ads.',
      solution: [
        'Meta Ads campaigns',
        'Local audience targeting',
      ...
      goal: 'Generate high-quality dental treatment inquiries and profitable patient leads despite heavy local competition.',
      results: [
  ...
  {
    id: 10,
    title: 'Chandu Bhojnalay Bhiwapur',
    category: 'Social Media Management',
    stats: 'Seasonal Traffic Boost',
    isLogoCard: true,
    logo: '/chandu-bhojnalay-logo.png',
    caseStudy: {
      client: 'Chandu Bhojnalay Bhiwapur',
      industry: 'Restaurant & Hospitality',
      location: 'Umred–Nagbhid Highway, Maharashtra',
      overview: 'Chandu Bhojnalay is a restaurant located on the busy Umred–Nagbhid Highway with a strong location advantage, quality food, and an existing customer base.',
      challenge: 'The restaurant wanted increased customer reach during the monsoon season and stronger Instagram presence.',
      solution: [
        'Instagram branding',
        'Social media growth strategy',
        'Video marketing',
        'Local awareness campaigns',
        'Restaurant-focused content strategy',
      ],
      goal: 'Increase customer engagement, boost seasonal traffic, and strengthen social media presence.',
      results: [
        'Successful trial campaign',
        'Video creative delivered',
        'Improved digital presence',
        'Awaiting full project confirmation',
      ],
    },
  },
  {
    id: 11,
    title: 'Avinash Media House',
    category: 'Social Media Management',
    stats: 'Brand Positioning Setup',
    isLogoCard: true,
    logo: '/avinash-media-logo.png',
    caseStudy: {
      client: 'Avinash Media House',
      industry: 'Media & Trading Content',
      location: 'India',
      overview: 'The client operates a media platform focused on trading-related content, market updates, and industry news.',
      challenge: 'The objective was to establish a strong identity on Instagram as a trusted source for trading news, updates, and market insights.',
      solution: [
        'Instagram branding',
        'Content strategy',
        'Trading-news positioning',
        'Reel creation',
        'Audience growth planning',
      ],
      goal: 'Build a professional social media identity and position the brand as a trusted trading news and updates channel.',
      results: [
        'Sample reel delivered successfully',
        'Brand positioning framework created',
        'Social media strategy prepared',
        'Awaiting project confirmation',
      ],
    },
  },
];
